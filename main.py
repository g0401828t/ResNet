...
parser.add_argument("--resnet_type", required=True, help="type of resnet")  # resnet18, resnet34, resnet50, resnet101, resnet152
...
if not os.path.exists(modelpath):
      os.mkdir(modelpath)
modelpath = modelpath + "/best_model_" + resnet_type + description + ".h"
...
def train():
    ...
    for epoch in range(epochs):
        ...
        plotgraph(loss_list=loss_list, valloss_list=valloss_list, valacc_list=valacc_list, path = resultpath, description=resnet_type+description)
